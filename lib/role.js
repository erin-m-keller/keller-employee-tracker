 ...
 * from the roles table in the database
 */
class Role {
    /**
     * @viewAllRoles
     ...
     * each role saved in the roles table
     * within the database
     */
     ...
     * salary and department of the
     * role, then uses an SQL query
     * to insert the role into the
